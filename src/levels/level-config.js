...
export const LEVELS = [
  // ── Level 1 — Tutorial ──────────────────────────────────────────────────────
  {
    ...
    isBoss: false,
    waves: [
      ...wave('drone', 30, { startTime: 3, interval: 8, speedMult: 0.6 }),
    ],
  },
  ...
  // ── Level 2 — Tutorial ──────────────────────────────────────────────────────
  {
    ...
    isBoss: false,
    waves: [
      ...wave('drone', 30, { startTime: 2, interval: 5, speedMult: 0.8 }),
    ],
  },
  ...
  // ── Level 3 ─────────────────────────────────────────────────────────────────
  {
    ...
    isBoss: false,
    waves: [
      ...wave('drone',  45, { startTime: 2,  interval: 5 }),
      ...wave('rusher', 45, { startTime: 12, interval: 18 }),
    ],
  },
  ...
  // ── Level 4 ─────────────────────────────────────────────────────────────────
  {
    ...
    waves: [
      ...
      ...wave('miniboss', 60, { startTime: 20, interval: 25 }),
    ],
  },
  ...
  // duration: null  →  no timer; the boss must die to advance
  {
    ...
    waves: [
      ...once('boss', 3),
      ...wave('drone', BOSS_FILL, { startTime: 15, interval: 15 }),
    ],
  },
  ...
  // ── Level 7 ─────────────────────────────────────────────────────────────────
  {
    ...
    isBoss: false,
    waves: [
      ...wave('drone', 60, { startTime: 2,  interval: 4,  healthMult: 1.5, speedMult: 1.1 }),
      ...wave('tank',  60, { startTime: 12, interval: 20 }),
    ],
  },
  ...
  // ── Level 9 ─────────────────────────────────────────────────────────────────
  {
    ...
    isBoss: false,
    waves: [
      ...wave('drone',    75, { startTime: 2, interval: 3,  healthMult: 1.5, speedMult: 1.2 }),
      ...wave('rusher',   75, { startTime: 5, interval: 8 }),
      ...wave('miniboss', 75, { startTime: 8, interval: 22, healthMult: 1.2 }),
    ],
  },
...
export function getLevelConfig(levelIndex) {
  ...
  return {
    ...
    isBoss: false,
    waves: [
      ...wave('drone',  dur, { startTime: 2,  interval,              healthMult: scale, speedMult: Math.min(scale * 0.8, 2.5) }),
